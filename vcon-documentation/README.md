# vCon Documentation Directory

## Purpose

This directory contains the IETF draft documents that define the vCon standard. The Skill automatically reads these files when performing validation.
...
✅ **draft-ietf-vcon-privacy-primer-00** (50 KB)
